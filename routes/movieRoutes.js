...
const { getMovielist, getMovie, getRecommendedMovies, likeMovie, dislikeMovie, getUserRecommendations, getPopularMovies, searchMovies } = require('../controllers/movieControllers');
